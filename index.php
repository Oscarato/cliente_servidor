...
function update_employe($id_employe){
    #$id_employe
    $employe = '[{"NOMBRE":" ADRIANA MARIA ","APELLIDO":"RODRIGUEZ MAMANCHE","IDENTIFICACION":"39804009","DIRECCION":"Cll 1 B Sur No A 01 Gran colom","TELEFONO":"no aplica","CELULAR":"3138948666","EMAIL":"adrianarm02@hotmail.com"}]';

    $employe = json_decode($employe);
    Flight::render('update', array('employe' => $employe[0] )); 
}
...
Flight::route('/update/@id_employe', 'update_employe');
